...
import {Close, Duo, Home, Logout, Message, Settings, Update, Newspaper, Notes} from "@mui/icons-material";
    ...
    return (
        <Box sx={{display: 'flex', flexDirection: 'column', height: '100%'}}>
            ...
            <List sx={{flexGrow: '1'}}>
                ...
                <ListItem disabled disablePadding  onClick={() => menuHandleClick(RouteNames.NEWS)} >
                    <Tooltip title="News" placement="right">
                        <ListItemButton>
                            <ListItemIcon>
                                <Newspaper />
                            </ListItemIcon>
                            <ListItemText sx={{whiteSpace: 'nowrap'}} primary={'Newspaper'} />
                            <Chip label="Newspaper" sx={{fontSize: 10, height: '25px'}}  />
                        </ListItemButton>
                    </Tooltip>
                </ListItem>

                <ListItem disabled disablePadding  onClick={() => menuHandleClick(RouteNames.NOTES)} >
                    <Tooltip title="Notes" placement="right">
                        <ListItemButton>
                            <ListItemIcon>
                                <Notes />
                            </ListItemIcon>
                            <ListItemText sx={{whiteSpace: 'nowrap'}} primary={'Notes'} />
                            <Chip label="Notes" sx={{fontSize: 10, height: '25px'}}  />
                        </ListItemButton>
                    </Tooltip>
                </ListItem>
